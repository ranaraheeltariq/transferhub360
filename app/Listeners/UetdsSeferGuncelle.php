...
class UetdsSeferGuncelle implements ShouldQueue
{
    ...
    public function handle(TransferCreated $event): void
    {
        ...
        $uetds = $this->seferGuncelle($event->transfer->uetds_id, $number_plate, $event->transfer->pickup_date, $starttime, $event->transfer->info, $event->transfer->id, $event->transfer->pickup_date, $endtime,$event->transfer->company->uetds_url, $event->transfer->company->uetds_username,$event->transfer->company->uetds_password);

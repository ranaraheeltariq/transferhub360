...
class OwnerAuthenticationController extends Controller
{
   ...
   /**
    ...
    /**
     * @OA\Post(
     *      path="/api/admin/users/device_token",
     *      operationId="AdminDeviceTokenUpdate",
     *      tags={"AdminAuth"},
     *      security={ {"bearerAuth":{} }},
     *      summary="Update admin device token",
     *      description="Returns Company admin data",
     *      @OA\RequestBody(
     *          required=true,
     *          description="I just fill Required Fields",
     *          @OA\MediaType(
     ...
     *              @OA\Property(property="data", type="string", example="array of admin data"),
     *          )
     *       ),
     *      @OA\Response(
     *          response=401,
    ...
    public function deviceTokenUpdate(Request $request)
    {
        ...
        $result = $this->ownerRepository->deviceTokenUpdate($data);
        if($result){
